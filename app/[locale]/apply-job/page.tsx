      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
        ...
        >
          ...
          >
            ...
            {/* Main Title */}
            <motion.h1
              className="text-4xl md:text-5xl lg:text-6xl font-black text-foreground mb-6 tracking-tight bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent"
              variants={itemVariants}
            >
              {t("title")}
            </motion.h1>
