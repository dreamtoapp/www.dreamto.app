    ...
    <div className="container mx-auto px-4 py-8">
      <section className="relative flex flex-col md:flex-row items-center justify-between gap-8 bg-gradient-to-br from-blue-900/80 via-blue-700/70 to-blue-400/40 dark:from-neutral-900/90 dark:via-neutral-800/80 dark:to-blue-900/30 rounded-3xl p-10 mb-12 shadow-xl border border-blue-100 dark:border-neutral-800 overflow-hidden backdrop-blur-md">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          <h1 className="text-5xl md:text-6xl font-black text-white drop-shadow-lg mb-4 tracking-tight">Our Team</h1>
          <p className="text-lg md:text-xl text-blue-100 dark:text-blue-200 max-w-2xl mb-4 font-medium "
           style={{textShadow: '0 1px 8px rgba(0,0,0,0.12)'}}>Meet the professionals behind our success.<br />We are passionate, experienced, and always looking for new talent to join us!</p>
        </div>
        <div className="relative z-10 flex-shrink-0 mt-8 md:mt-0 flex justify-center md:justify-end w-full md:w-auto">
          <Link href={`/${locale}/team/apply`}>
            <span className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-blue-400 hover:from-blue-700 hover:to-blue-500 text-white font-extrabold text-xl shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300">
      ...
      <div className="border-t border-blue-200 dark:border-neutral-700 mb-10" />
